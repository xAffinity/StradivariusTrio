...
class TSL2561:
    #lux_scale address array from datasheet 
    _LUX_SCALE = (
    #       K       B       M
    ...
    #connection of tsl2561 sensor to esp8266
    def __init__(self, i2c, address=0x39): #slave address for connection with host controller esp8266 (from datasheet)
        self.i2c = i2c
...
#package initialisation (identical packages)
TSL2561T = TSL2561
TSL2561FN = TSL2561
TSL2561CL = TSL2561
...
class TSL2561CS(TSL2561):
    #lux_scale address array for TSL2561CS package
    _LUX_SCALE = (
    #       K       B       M
